...
class DeviceInfoPage extends StatelessWidget {
  ...
  final TextEditingController typeController =
      TextEditingController(text: "Setup Box");
  final TextEditingController brandController =
      TextEditingController(); // Remove predefined text, user will enter the brand
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: "Brand",
                        hintText:
                            "Enter device name", // Hint text for the brand name
                        border: InputBorder.none,
                      ),
                    ),
                    Divider(),
